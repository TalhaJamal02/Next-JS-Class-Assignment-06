...
function Hero() {
  return (
    <div className="w-full flex flex-col md:flex-row  justify-between md:pl-3">
      ...
      {/* Left Side */}
      <div className=" lg:w-[500px] flex justify-center flex-col gap-6 text-left p-6">
        ...
        <div className="flex flex-row gap-4 pt-4">
          <button className=" p-3 rounded-[5px] bg-black md:w-full text-white w-1/2">
            Start learning now
          </button>
          <button className="p-3 border border-black rounded-[5px] bg-transparent text-black md:w-full w-1/2">
            Explore Courses
          </button>
        </div>
      </div>
